...
function AlphabetsGame() {
  ...
  const [mascotText, setMascotText] = useState('Catch the right letter! 🔤')
  const [feedback, setFeedback] = useState(null)
  const [gameOver, setGameOver] = useState(false)
  const [round, setRound] = useState(1)

  const allQuestions = [
    { question: 'Which letter comes after A?', answer: 'B', options: ['B', 'C', 'D', 'E'] },
    { question: 'Which letter comes after D?', answer: 'E', options: ['E', 'F', 'G', 'C'] },
    { question: 'How many letters are in the alphabet?', answer: '26', options: ['26', '24', '28', '30'] },
    { question: 'Which of these is a VOWEL?', answer: 'A', options: ['A', 'B', 'C', 'D'] },
    { question: 'Which of these is a VOWEL?', answer: 'O', options: ['O', 'P', 'Q', 'R'] },
    { question: 'Which letter comes before Z?', answer: 'Y', options: ['Y', 'X', 'W', 'V'] },
    { question: 'How many VOWELS are in the alphabet?', answer: '5', options: ['5', '6', '4', '7'] },
    { question: 'Which of these is a CONSONANT?', answer: 'B', options: ['B', 'A', 'E', 'I'] },
    { question: 'Which letter comes after M?', answer: 'N', options: ['N', 'O', 'P', 'L'] },
    { question: 'Which letter comes first in the alphabet?', answer: 'A', options: ['A', 'B', 'Z', 'M'] },
  ]
  ...
  const handleAnswer = (option) => {
    ...
    if (option === question.answer) {
      setScore(score + 10)
      setFeedback('correct')
      setMascotText('Wonderful! You know your ABCs! 🌟')
      setTimeout(() => {
      ...
      setLives(lives - 1)
      setFeedback('wrong')
      setMascotText('Keep practicing your letters! 💪')
      if (lives - 1 <= 0) {
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
        ...
        <h2 style={{ color: '#FFD700', fontSize: '22px' }}>🔤 Alphabets Game</h2>
