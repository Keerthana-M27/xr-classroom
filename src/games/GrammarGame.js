...
function GrammarGame() {
  ...
  const [mascotText, setMascotText] = useState('Sort the words correctly! 📝')
  const [feedback, setFeedback] = useState(null)
  const [gameOver, setGameOver] = useState(false)
  const [round, setRound] = useState(1)

  const allQuestions = [
    { question: 'Which word is a NOUN?', emoji: '📌', answer: 'Apple 🍎', options: ['Apple 🍎', 'Run 🏃', 'Happy 😊', 'Quickly ⚡'] },
    { question: 'Which word is a VERB?', emoji: '📌', answer: 'Jump 🦘', options: ['Jump 🦘', 'Dog 🐶', 'Big 📏', 'Red 🔴'] },
    { question: 'Which word is an ADJECTIVE?', emoji: '📌', answer: 'Beautiful 🌸', options: ['Beautiful 🌸', 'Cat 🐱', 'Eat 🍽️', 'Slowly 🐌'] },
    { question: 'Which is the correct sentence?', emoji: '✍️', answer: 'The cat is big.', options: ['The cat is big.', 'the cat is big.', 'The Cat Is Big.', 'THE CAT IS BIG.'] },
    { question: 'Which word is a NOUN?', emoji: '📌', answer: 'School 🏫', options: ['School 🏫', 'Swim 🏊', 'Tall 📏', 'Fast ⚡'] },
    { question: 'Which word is a VERB?', emoji: '📌', answer: 'Eat 🍽️', options: ['Eat 🍽️', 'House 🏠', 'Small 🔬', 'Blue 🔵'] },
    { question: 'A sentence must start with a?', emoji: '✍️', answer: 'Capital letter 🔠', options: ['Capital letter 🔠', 'Small letter 🔡', 'Number 🔢', 'Symbol ⭐'] },
    { question: 'Which word is an ADJECTIVE?', emoji: '📌', answer: 'Tall 📏', options: ['Tall 📏', 'Tree 🌳', 'Run 🏃', 'Slowly 🐌'] },
    { question: 'Which word is a NOUN?', emoji: '📌', answer: 'India 🇮🇳', options: ['India 🇮🇳', 'Dance 💃', 'Cold 🥶', 'Very ⭐'] },
    { question: 'A sentence must end with a?', emoji: '✍️', answer: 'Full stop . ', options: ['Full stop . ', 'Comma , ', 'Star ⭐', 'Nothing'] },
  ]
  ...
  const handleAnswer = (option) => {
    ...
    if (option === question.answer) {
      setScore(score + 10)
      setFeedback('correct')
      setMascotText('Grammar genius! You are amazing! 🌟')
      setTimeout(() => {
      ...
      setLives(lives - 1)
      setFeedback('wrong')
      setMascotText('Keep reading and learning! 📚')
      if (lives - 1 <= 0) {
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
        ...
        <h2 style={{ color: '#FFD700', fontSize: '22px' }}>📝 Grammar Game</h2>
