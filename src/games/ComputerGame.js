...
function ComputerGame() {
  ...
  const [mascotText, setMascotText] = useState('What part of computer is this? 💻')
  const [feedback, setFeedback] = useState(null)
  const [gameOver, setGameOver] = useState(false)
  const [round, setRound] = useState(1)

  const allQuestions = [
    { emoji: '🖥️', question: 'What shows us pictures and text on a computer?', answer: '🖥️ Monitor', options: ['🖥️ Monitor', '⌨️ Keyboard', '🖱️ Mouse', '💾 Disk'] },
    { emoji: '⌨️', question: 'What do we use to type letters and numbers?', answer: '⌨️ Keyboard', options: ['⌨️ Keyboard', '🖥️ Monitor', '🖱️ Mouse', '🔊 Speaker'] },
    { emoji: '🖱️', question: 'What do we use to click and move on screen?', answer: '🖱️ Mouse', options: ['🖱️ Mouse', '⌨️ Keyboard', '🖥️ Monitor', '💡 Light'] },
    { emoji: '💻', question: 'What is the brain of the computer called?', answer: '💾 CPU', options: ['💾 CPU', '🖥️ Monitor', '🖱️ Mouse', '🔊 Speaker'] },
    { emoji: '🔊', question: 'What gives us sound from the computer?', answer: '🔊 Speaker', options: ['🔊 Speaker', '🖥️ Monitor', '⌨️ Keyboard', '🖱️ Mouse'] },
    { emoji: '💡', question: 'What do we press to turn on the computer?', answer: '⚡ Power button', options: ['⚡ Power button', '🖱️ Mouse click', '⌨️ Any key', '🔊 Speaker'] },
    { emoji: '📁', question: 'Where do we save our files on a computer?', answer: '📁 Folder', options: ['📁 Folder', '🖥️ Monitor', '🖱️ Mouse', '⌨️ Keyboard'] },
    { emoji: '🖨️', question: 'What machine prints our documents on paper?', answer: '🖨️ Printer', options: ['🖨️ Printer', '🖥️ Monitor', '📷 Camera', '🔊 Speaker'] },
    { emoji: '💾', question: 'What do we use to save our work?', answer: '💾 Save button', options: ['💾 Save button', '❌ Delete key', '🖱️ Right click', '🔊 Speaker'] },
    { emoji: '🌐', question: 'What connects computers around the world?', answer: '🌐 Internet', options: ['🌐 Internet', '🔊 Speaker', '🖱️ Mouse', '⌨️ Keyboard'] },
  ]
  ...
  const handleAnswer = (option) => {
    ...
    if (option === question.answer) {
      setScore(score + 10)
      setFeedback('correct')
      setMascotText('You are a tech genius! 💻')
      setTimeout(() => {
      ...
      setLives(lives - 1)
      setFeedback('wrong')
      setMascotText('Keep learning about computers! 🌟')
      if (lives - 1 <= 0) {
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
        ...
        <h2 style={{ color: '#FFD700', fontSize: '22px' }}>💻 Computer Game</h2>
