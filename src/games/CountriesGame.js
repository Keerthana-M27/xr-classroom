...
function CountriesGame() {
  ...
  const [mascotText, setMascotText] = useState('Which country is this? 🗺️')
  const [feedback, setFeedback] = useState(null)
  const [gameOver, setGameOver] = useState(false)
  const [round, setRound] = useState(1)

  const allQuestions = [
    { emoji: '🇮🇳', question: 'Which country is this flag? 🇮🇳', answer: '🇮🇳 India', options: ['🇮🇳 India', '🇨🇳 China', '🇧🇷 Brazil', '🇺🇸 USA'] },
    { emoji: '🏆', question: 'Which is the BIGGEST country in the world?', answer: '🇷🇺 Russia', options: ['🇷🇺 Russia', '🇨🇳 China', '🇺🇸 USA', '🇮🇳 India'] },
    { emoji: '🌍', question: 'How many countries are in the world?', answer: '195 countries', options: ['195 countries', '150 countries', '200 countries', '100 countries'] },
    { emoji: '🇺🇸', question: 'Which country is this flag? 🇺🇸', answer: '🇺🇸 USA', options: ['🇺🇸 USA', '🇬🇧 UK', '🇦🇺 Australia', '🇨🇦 Canada'] },
    { emoji: '🏯', question: 'Which country has the Great Wall?', answer: '🇨🇳 China', options: ['🇨🇳 China', '🇯🇵 Japan', '🇮🇳 India', '🇰🇷 Korea'] },
    { emoji: '🗼', question: 'Which country has the Eiffel Tower?', answer: '🇫🇷 France', options: ['🇫🇷 France', '🇮🇹 Italy', '🇩🇪 Germany', '🇪🇸 Spain'] },
    { emoji: '🇯🇵', question: 'Which country is this flag? 🇯🇵', answer: '🇯🇵 Japan', options: ['🇯🇵 Japan', '🇨🇳 China', '🇰🇷 Korea', '🇹🇭 Thailand'] },
    { emoji: '🦘', question: 'Which country are Kangaroos from?', answer: '🇦🇺 Australia', options: ['🇦🇺 Australia', '🇿🇦 South Africa', '🇧🇷 Brazil', '🇨🇦 Canada'] },
    { emoji: '🍕', question: 'Which country is Pizza originally from?', answer: '🇮🇹 Italy', options: ['🇮🇹 Italy', '🇫🇷 France', '🇺🇸 USA', '🇩🇪 Germany'] },
    { emoji: '🇧🇷', question: 'Which country has the Amazon Rainforest?', answer: '🇧🇷 Brazil', options: ['🇧🇷 Brazil', '🇮🇳 India', '🇨🇳 China', '🇲🇽 Mexico'] },
  ]
  ...
  const handleAnswer = (option) => {
    ...
    if (option === question.answer) {
      setScore(score + 10)
      setFeedback('correct')
      setMascotText('World traveller! Amazing! 🌍')
      setTimeout(() => {
      ...
      setLives(lives - 1)
      setFeedback('wrong')
      setMascotText('Keep exploring countries! 🗺️')
      if (lives - 1 <= 0) {
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
        ...
        <h2 style={{ color: '#FFD700', fontSize: '22px' }}>🗺️ Countries Game</h2>
